# -*- coding: utf-8 -*-
"""
Created on Mon Aug 12 14:50:36 2019

@author: Li Xiang

The experiment use trained model directly without finetuning using half of needs data.

*each time fix cur_sent_embd_type and:
*run these 2files 5 times:(each with different types)

    run multitask_1_new_cpu_label to get review (trainset) y_labels for 5 types
    
    run multitask_2_new_cpu_label to get needs data (val, test) y_labels for 5 types
