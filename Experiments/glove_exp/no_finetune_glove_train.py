# -*- coding: utf-8 -*-
"""
Created on Mon Aug 12 12:07:14 2019

@author: Li Xiang

train and not finetune the MLP classifier and save to folder (./models/no_finetune_XX)
...
cur_sent_embd_type='concat'#['ave','max','concat','hier']
K=5 #top K results for evaluation
...
model_name='./models/'+'no_finetune_'+cur_exp_param+'_'+cur_sent_embd_type+'_model.pkl'
joblib.dump(classifier, model_name)


print("now classifier is ready to test")
